      ...
      <div style={{ height: "100%", overflow: "auto" }}>
        ...
        <div style={{ padding: "8px 12px", background: COLORS.bgPanel, borderBottom: `1px solid ${COLORS.border}` }}>
          ...
          >
            ...
            <ChevronDown size={16} color={COLORS.textMuted} style={{ transform: showStockList ? "rotate(180deg)" : "none" }} />
          </div>
          {showStockList && (
        ...
        <div style={{ padding: "8px 12px", background: COLORS.bgPanel, borderBottom: `1px solid ${COLORS.border}` }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <DataCell label="Chg" value={fmtPct(selected.changePercent)} color={selected.changePercent >= 0 ? COLORS.green : COLORS.red} />
            <DataCell label="MCap" value={fmtK(selected.marketCap)} />
          </div>
        </div>
  ...
  if (tab === "CHART") {
    return (
      <Panel>
        ...
        <div style={{ padding: 8, height: isMobile ? 240 : 320 }}>
          {histLoading ? (
